...
:page-seo-title: Implementing an Eclipse MicroProfile GraphQL microservice to query and update web services.
...
= Building a GraphQL microservice to query web services
