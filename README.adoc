...
You can also apply various annotations to the properties and declaration of a Java class to define an object type.
...
The `java` object type gives information on the system's Java installation. 
...
The [hotspot=graphqlapi file=0]`@GraphQLApi` annotation enables GraphQL to use the methods defined in this class as resolvers. 
