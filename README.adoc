...
Note that some of these properties were not referenced in our GraphQL object types, 
as not all of these properties have been mapped to GraphQL object types or fields. 
