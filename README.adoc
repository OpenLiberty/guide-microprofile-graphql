...
:page-seo-description: Find out how to create and test a GraphQL web service on Open Liberty
...
You will create a GraphQL web service that stores, queries and manipulates album and artist information.
