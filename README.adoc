...
It maps to the [hotspot=type file=1]`metrics` object type,
...
The [hotspot file=1]`SystemMetricsResource` class provides information on the system's resources and their usage.
...
it's used to connect the [hotspot=javaFunction file=0]`java` and [hotspot=systemMetricsFunction file=0]`metrics`
