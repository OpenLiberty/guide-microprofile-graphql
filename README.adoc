...
[role='command']
link:{common-includes}/gitclone.adoc[]
...
[role='command']
link:{common-includes}/twyb-intro.adoc[]
...
[role='command']
link:{common-includes}/twyb-end.adoc[]
...
[role='command']
link:{common-includes}/devmode-start.adoc[]
...
[role='command']
link:{common-includes}/devmode-build.adoc[]
...
[role='command']
link:{common-includes}/devmode-test.adoc[]

[role='command']
link:{common-includes}/devmode-quit.adoc[]
...
link:{common-includes}/attribution.adoc[]
