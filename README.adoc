...
It will describe the operating system running on the computer the application is running on. 
...
They'll instead be added as part of implementing the resolver functions.
