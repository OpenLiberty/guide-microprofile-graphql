...
The [hotspot=class file=3]`SystemLoad` class maps to the `systemLoad`
object type, which describes the resource usage of a `system` service.
The [hotspot=class file=4]`SystemLoadData` class maps to the `loadData` object type.
This will be a nested object inside the `systemLoad` object type.
It will contain the details of the resource usage of a `system` service.
