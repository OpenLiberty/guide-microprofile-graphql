...
In GraphiQL you will also be able to view the application's documentation by clicking `Docs`. 
The documentation will describe the GraphQL schema.
This gives details on the various operations available and descriptions of them. 
...
You'll receive a response containing the boolean `true` to notify you that the request was successfully processed.
