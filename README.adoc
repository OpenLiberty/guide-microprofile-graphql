...
Annotations applied to the declaration and properties of Java classes define object types.
...
This guide contains an example of a `query` operation, and a `mutation` operation. 
