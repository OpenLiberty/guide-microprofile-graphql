...
You'll enable the interactive GraphQL tool called
https://github.com/graphql/graphiql/tree/main/packages/graphiql[GraphiQL^] in the Open Liberty server.
